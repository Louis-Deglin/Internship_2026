...
#SBATCH -J DV_array_2.0
#SBATCH -t 48:00:00
#SBATCH -n 1
#SBATCH -c 20
#SBATCH --mem=120G
#SBATCH --array=0-7
#SBATCH -o logs/deepvariant_2.0_%A_%a.out
#SBATCH -e logs/deepvariant_2.0_%A_%a.err
...
OUTDIR=$BREEDMAPS/louis/results/DeepVariant/ARS-UCD2.0/pr_219_${ID}
...
echo "=== DeepVariant pour pr_219_${ID} (Réf 2.0) === BAM: ${BAM_NAME} === $(date) ==="
...
echo "End of job pour pr_219_${ID} : $(date)"
