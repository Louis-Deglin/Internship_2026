...
#SBATCH -c 4
#SBATCH --mem=16G
#SBATCH -o logs/clean_afrikaner_%j.out
#SBATCH -e logs/clean_afrikaner_%j.err
...
BASE_DIR="$BREEDMAPS/louis/results/DeepVariant/Afrikaner_ARS2.0"
...
for ID in 025 026 027 028 029 030 031 032; do
    ...
    rm -f ${DIR}/header.txt ${DIR}/clean_header.txt

done

echo "=== Nettoyage terminé pour les Afrikaner === $(date)"
