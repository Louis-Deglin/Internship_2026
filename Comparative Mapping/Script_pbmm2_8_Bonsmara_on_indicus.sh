...
#SBATCH -c 32
#SBATCH --mem=64G
#SBATCH -J pbmm2_brahman
#SBATCH --array=0-7
#SBATCH -o logs/pbmm2_brahman_%A_%a.out
#SBATCH -e logs/pbmm2_brahman_%A_%a.err
...
OUTDIR=$BREEDMAPS/louis/results/pbmm2/UOA_Brahman_1/pr_219_${ID}
mkdir -p ${OUTDIR}
...
singularity exec --bind $BREEDMAPS:$BREEDMAPS \
    ...
    pbmm2 align \
    $BREEDMAPS/louis/reference/Bos_indicus_hybrid.UOA_Brahman_1.dna.toplevel.fa \
    ${BAM} \
