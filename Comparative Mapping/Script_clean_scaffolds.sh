...
#SBATCH -J Clean_Brahman
#SBATCH -t 00:30:00
#SBATCH -n 1
#SBATCH -c 8
#SBATCH --mem=32G
#SBATCH -o logs/clean_brahman_%j.out
#SBATCH -e logs/clean_brahman_%j.err
...
BASE_DIR="$BREEDMAPS/louis/results/DeepVariant/UOA_Brahman_1"
...
for ID in 033 034 035 036 037 038 039 040; do
    ...
    grep -v "ID=PUFS" ${DIR}/header.txt | grep -v "ID=NKLS" > ${DIR}/clean_header.txt
