...
#SBATCH -J Clean_NKLS_Bons_Y
#SBATCH -t 00:30:00
#SBATCH -n 1
#SBATCH -c 8
#SBATCH --mem=32G
#SBATCH -o logs/clean_nkls_bons_Y_%j.out
#SBATCH -e logs/clean_nkls_bons_Y_%j.err
...
BASE_DIR="$BREEDMAPS/louis/results/DeepVariant/Bonsmara_Y"

for ID in 033 034 035 036 037 038 039 040; do

    DIR="${BASE_DIR}/pr_219_${ID}"

    ORIGINAL_VCF="${DIR}/pr_219_${ID}_chrY.deepvariant.g.vcf.gz"
    CLEANED_VCF="${DIR}/pr_219_${ID}_chrY.clean.g.vcf.gz"
